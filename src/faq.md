...
As a part of the roadmap; the squad will vote if to continue to have a multi-sig based treasury or move to a complete trustless setup.
...
To build trust, and decentralize, the DAO is collborating with six Sentinels who are not core-members.
